  ...
  <div class="print_container">
    ...
    <div>
                    ...
                    <form>
                      ...
                      <div class="accordion-item d-grid gap-2 mt-2">
                        <h2 class="accordion-header" id="headingThree">
                          <button
                            class="accordion-button collapsed cancel_modal_btn btn-lg"
                            type="button"
      ...
      <div class="orderprint_box2">
        ...
        <!--///영수증 인쇄 옆 버튼-->
        <!--인쇄옆 상하버튼 클릭시 스크롤기능 추가해야함 -->
        <div class="print_btn-cover">
          <router-link to="./member/OrderPrint"
            ><button type="text" class="print_receipt_btn" onclick="window.print()">주문표 인쇄</button></router-link
          >
          ...
          <button
            :disabled="menulistpageNum >= pageCount - 1"
            @click="nextPage2, scrollToBottom"
            class="print_page-btn"
          >
